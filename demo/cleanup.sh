...
kubectl -n cis-test delete svc owasp-juiceshop
kubectl -n cis-test delete deployment owasp-juiceshop
kubectl -n cis-test delete configmaps f5-as3-declaration-juiceshop
# delete fw rule
